...
import { ArrowUpDown, Search, Download, X, ChevronRight, ChevronDown, DollarSign as DollarSignIcon, RotateCcw, BedDouble, Lock, Wifi, Wind, ExternalLink, Trash2, TrendingUp, Wallet, Percent, FlaskConical } from 'lucide-react'
...
export default function TestPage() {
  ...
  return (
    <PageContainer width="full" className="h-full flex flex-col">
      <PageHeader
        title="Master List"
        subtitle="Full Cost Tracking page wearing the redesign — every column, inline edit, and detail intact. Live data (edits save). Click cells to edit financials; expand a row for full details."
