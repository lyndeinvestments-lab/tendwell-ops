...
import { ChevronDown, ChevronRight, Eye, EyeOff, Minimize2, ArrowUp, CalendarDays, Search, Plus, X, GripVertical, AlertTriangle, FlaskConical } from 'lucide-react'
...
export default function TestPage() {
  ...
  usePageTitle('Pipeline — Redesign Preview')
