...
export const linensEn = {
  ...
  // Damaged Linen Tracker (/damaged-linens). Item/damage/status maps are
  // keyed by the DB slug; page code falls back to the English label in
  // client/src/lib/damaged-linens.ts when a key is missing.
  damaged: {
    page: {
      title: 'Damaged Linens',
      subtitle: 'Stained and damaged linens across the portfolio',
      report: 'Report damage',
      searchPlaceholder: 'Search property, item, notes…',
      exportCsv: 'Export CSV',
      exported: 'Exported {count} rows',
      errorLoad: 'Could not load damaged linens',
      emptyTitle: 'No damaged linens logged',
      emptyDescription: 'When a cleaner finds a stained or damaged item, log it here to track it through treatment or replacement.',
    ...
    kpi: {
      open: 'Open items',
      openSub: '{count} reports awaiting treatment',
      discarded: 'Written off',
      discardedSub: 'units discarded in range',
      loss: 'Est. replacement cost',
      lossSub: 'from discarded items',
      restoreRate: 'Saved by treatment',
      restoreRateSub: '{restored} restored of {resolved} resolved',
      chargeBack: '{count} open charge-backs',
    },
    hotspots: {
      properties: 'Most damage by property',
      items: 'Most damaged items',
      units: '{count} units',
      reports: '{count} reports',
      none: 'Nothing in this range yet.',
    },
    table: {
      found: 'Found',
      property: 'Property',
    ...
    form: {
      titleNew: 'Report damaged linen',
      titleEdit: 'Damaged linen',
      description: 'Log each stained or damaged item so we can treat it, replace it, or charge it back.',
      property: 'Property',
      ...
      estimatedCost: 'Est. replacement cost ($)',
      estimatedCostHint: 'Total for all units — used for the written-off total.',
      chargeBack: 'Guest damage — pursue a charge-back',
      notes: 'Notes',
      notesPlaceholder: 'Where it was found, what the stain looks like, treatment tried…',
      photos: 'Photos',
      addPhoto: 'Add photo',
      save: 'Save',
      saving: 'Saving…',
      ...
      resolvedOn: 'Resolved {date} by {name}',
      resolvedOnNoName: 'Resolved {date}',
      quickActions: 'Quick update',
    },
    toasts: {
      saved: 'Report saved',
      ...
      statusChanged: 'Marked {status}',
    },
    items: {
      king_fitted: 'King Fitted Sheet',
      king_flat: 'King Flat Sheet',
      king_pillowcase: 'King Pillowcase',
      queen_fitted: 'Queen Fitted Sheet',
      queen_flat: 'Queen Flat Sheet',
      queen_pillowcase: 'Queen Pillowcase',
      full_fitted: 'Full Fitted Sheet',
      full_flat: 'Full Flat Sheet',
      full_pillowcase: 'Full Pillowcase',
      twin_fitted: 'Twin Fitted Sheet',
      twin_flat: 'Twin Flat Sheet',
      twin_pillowcase: 'Twin Pillowcase',
      duvet_cover: 'Duvet Cover',
      comforter: 'Comforter / Duvet Insert',
      mattress_encasement: 'Mattress Encasement',
      pillow: 'Pillow',
