...
export const contactsEn = {
  ...
  page: {
    ...
    addOrganizationButton: 'Add Company',
  ...
  org: {
    ...
    fieldNotes: 'Notes',
    placeholderName: 'e.g. Scenic Stay Collection',
    placeholderNotes: 'Billing notes, HQ, etc.',
    helpText: 'People (points of contact) link to this company and share its property portfolio in their portals.',
    toastCreated: 'Company created',
    toastUpdated: 'Company updated',
    toastSaveFailed: 'Could not save company',
    toastNameRequired: 'Company name is required',
    none: 'No company',
    createInline: 'Create new company…',
  },
  sourceReport: {
  ...
  modal: {
    ...
    fieldCompany: 'Company (legacy label)',
    fieldOrganization: 'Company account',
    ...
    assignButton: 'Assign',
    noLinkedProperties: 'No properties linked to this contact or their company',
    sharedViaOrg: 'Shared via company',
