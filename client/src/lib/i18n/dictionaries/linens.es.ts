...
export const linensEs: typeof linensEn = {
  ...
  damaged: {
    page: {
      title: 'Ropa de Cama Dañada',
      subtitle: 'Ropa de cama manchada y dañada en todas las propiedades',
      report: 'Reportar daño',
      searchPlaceholder: 'Buscar propiedad, artículo, notas…',
      exportCsv: 'Exportar CSV',
      exported: '{count} filas exportadas',
      errorLoad: 'No se pudo cargar la ropa de cama dañada',
      emptyTitle: 'No hay ropa de cama dañada registrada',
      emptyDescription: 'Cuando un limpiador encuentre un artículo manchado o dañado, regístrelo aquí para darle seguimiento hasta su tratamiento o reemplazo.',
      noMatches: 'Ningún reporte coincide con estos filtros.',
      noProperty: 'Sin propiedad',
    },
    filters: {
      open: 'Abiertos',
      allStatuses: 'Todos los estados',
      allDamage: 'Todos los tipos de daño',
    ...
    kpi: {
      open: 'Artículos abiertos',
      openSub: '{count} reportes esperando tratamiento',
      discarded: 'Dados de baja',
      discardedSub: 'unidades desechadas en el periodo',
      loss: 'Costo est. de reemplazo',
      lossSub: 'de artículos desechados',
      restoreRate: 'Recuperados con tratamiento',
      restoreRateSub: '{restored} recuperados de {resolved} resueltos',
      chargeBack: '{count} cobros al huésped abiertos',
    },
    hotspots: {
      properties: 'Más daños por propiedad',
      items: 'Artículos más dañados',
      units: '{count} unidades',
      reports: '{count} reportes',
      none: 'Aún no hay nada en este periodo.',
    },
    table: {
      found: 'Encontrado',
      property: 'Propiedad',
    ...
    form: {
      titleNew: 'Reportar ropa de cama dañada',
      titleEdit: 'Ropa de cama dañada',
      description: 'Registre cada artículo manchado o dañado para tratarlo, reemplazarlo o cobrarlo.',
      property: 'Propiedad',
      ...
      status: 'Estado',
      foundDate: 'Fecha encontrada',
      foundBy: 'Encontrado por',
      selectCleaner: 'Seleccionar limpiador',
      searchCleaners: 'Buscar limpiadores…',
      estimatedCost: 'Costo est. de reemplazo ($)',
      estimatedCostHint: 'Total de todas las unidades — se usa para el total dado de baja.',
      chargeBack: 'Daño del huésped — solicitar cobro',
      notes: 'Notas',
      notesPlaceholder: 'Dónde se encontró, cómo se ve la mancha, tratamiento intentado…',
      photos: 'Fotos',
      addPhoto: 'Agregar foto',
      save: 'Guardar',
      saving: 'Guardando…',
      delete: 'Eliminar',
      confirmDelete: '¿Eliminar este reporte? No se puede deshacer.',
      resolvedOn: 'Resuelto el {date} por {name}',
      resolvedOnNoName: 'Resuelto el {date}',
      quickActions: 'Actualización rápida',
    },
    toasts: {
      ...
      statusChanged: 'Marcado como {status}',
    },
    items: {
      king_fitted: 'Sábana Ajustable King',
      king_flat: 'Sábana Plana King',
      king_pillowcase: 'Funda de Almohada King',
      queen_fitted: 'Sábana Ajustable Queen',
      queen_flat: 'Sábana Plana Queen',
      queen_pillowcase: 'Funda de Almohada Queen',
      full_fitted: 'Sábana Ajustable Full',
      full_flat: 'Sábana Plana Full',
      full_pillowcase: 'Funda de Almohada Full',
      twin_fitted: 'Sábana Ajustable Twin',
      twin_flat: 'Sábana Plana Twin',
      twin_pillowcase: 'Funda de Almohada Twin',
      duvet_cover: 'Funda de Edredón',
      comforter: 'Edredón / Relleno',
      mattress_encasement: 'Protector de Colchón',
      pillow: 'Almohada',
      bath_towel: 'Toalla de Baño',
      hand_towel: 'Toalla de Mano',
      washcloth: 'Toallita',
      bathmat: 'Tapete de Baño',
      pool_towel: 'Toalla de Piscina',
      kitchen_towel: 'Toalla de Cocina',
      other: 'Otro',
    },
    itemGroups: {
    ...
    damageTypes: {
      ...
      tear: 'Rotura / Agujero',
      burn: 'Quemadura',
      discoloration: 'Decoloración / Cloro',
      worn: 'Desgastado',
      other: 'Otro',
    },
    statuses: {
